...
function OhmMenu() {
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="MOOB" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>MOOB</Typography>
      </Button>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("MOOB", WAND_ADDRESS)}>
                        <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 1200 1200"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">MOOB </Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sMOOB", SWAND_ADDRESS)}>
                      <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 1200 1200"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">sMOOB</Typography>
                      </Button>
                    </Box>
                  </Box>
                ) : null}
