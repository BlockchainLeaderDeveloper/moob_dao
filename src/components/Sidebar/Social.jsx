  ...
  return (
    <div>
      <div className="social-row">
        <Link href="https://t.me/MOOBDAO" target="_blank">
          <SvgIcon color="primary" component={Telegram} />
        </Link>
        <Link href="https://twitter.com/Moob_Financial" target="_blank">
          <SvgIcon color="primary" component={Twitter} />
        </Link>

        <Link href="https://discord.com/invite/moobdao" target="_blank">
          <SvgIcon color="primary" component={Discord} />
        </Link>

        <Link href="https://medium.com/@moobfinancial" target="_blank">
