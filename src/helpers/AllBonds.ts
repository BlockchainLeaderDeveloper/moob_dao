...
export const moob_busd = new LPBond({
  name: "moob_busd_lp",
  displayName: "MOOB-BUSD LP",
  bondToken: "BUSD",
  ...
  lpUrl:
    "https://pancakeswap.finance/add/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56/0x9424D4452B65C4348aD4EBA2198497F40a3a898f",
});
...
export const allBonds = [busd, moob_busd];//mtn_wbnb, cake
