...
function Stake() {
  ...
  const shecBalance = useSelector(state => {
    console.log('shecBalance2',state)
  ...
  const onChangeStake = async (action, isOld) => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(ohmBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your MOOB balance."));
    }
    
    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(unstakedVal, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sMOOB balance."));
    }
    await dispatch(
      changeStake({
        address,
                ...
                <div className="card-header">
                  ...
                  {address && oldSohmBalance > 0.01 && (
                    ...
                    >
                      ...
                      <Typography>Migrate sMOOB!</Typography>
                    </Link>
                  )}
                </div>
              </Grid>
                  ...
                  <Grid container spacing={2} alignItems="flex-end">
                    ...
                    <Grid item xs={12} sm={4} md={4} lg={4}>
                      <div className="stake-index">
                        ...
                        <Typography variant="h4">
                          {currentIndex ? <>{trim(currentIndex, 1)} MOOB</> : <Skeleton width="150px" />}
                        </Typography>
                      </div>
                    </Grid>
                  </Grid>
              ...
              <div className="staking-area">
                {!address ? (
                  <div className="stake-wallet-notification">
                    ...
                    <Typography variant="h6">Connect your wallet to stake MOOB</Typography>
                  </div>
                ) : (
                  <>
                      ...
                      <Box className="stake-action-row " display="flex" alignItems="center">
                          ...
                          (!hasAllowance("ohm") && view === 0) || (!hasAllowance("sohm") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>MOOB</b>?
                                    <br />
                                    Please approve Moob DAO to use your <b>MOOB</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sMOOB</b>?
                                    <br />
                                    Please approve Moob DAO to use your <b>sMOOB</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                        ...
                        <TabPanel value={view} index={0} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "staking", "Stake MOOB")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                        ...
                        <TabPanel value={view} index={1} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "unstaking", "Unstake MOOB")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} MOOB</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sMOOB</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sMOOB</>}
                        </Typography>
                      </div>
